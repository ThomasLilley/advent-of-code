...
void readFile() {
  _pairs =
      File('2022/day-4/advent22-04-input.txt').readAsStringSync().split("\n");
}
...
int _pairCount = 0;
  ...
  _pairs.forEach((element) {
    ...
    if(_sectionOne.first >= _sectionTwo.first && _sectionOne.last <= _sectionTwo.last) _pairCount++; //pair 1 fits into 2
